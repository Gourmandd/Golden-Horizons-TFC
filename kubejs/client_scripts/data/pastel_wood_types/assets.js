ClientEvents.generateAssets("after_mods", event => {
    ...
    global.PASTEL_WOOD_TYPES.forEach(woodType => {
        ...
        datagen.shelfBlockModel(`${mod_id}:wood/shelf/${woodType}`, global.CUSTOM_WOOD_TEXTURES["planks"][woodType])
        datagen.loomBlockModel(`${mod_id}:wood/loom/${woodType}`, global.CUSTOM_WOOD_TEXTURES["planks"][woodType])
        datagen.toolRackBlockModel(`${mod_id}:wood/tool_rack/${woodType}`, global.CUSTOM_WOOD_TEXTURES["stripped_log_side"][woodType])
        datagen.sluiceBlockModel(`${mod_id}:wood/sluice/${woodType}`, global.CUSTOM_WOOD_TEXTURES["stripped_log_side"][woodType])
    })
})
