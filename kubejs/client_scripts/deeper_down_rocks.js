...
ClientEvents.generateAssets("after_mods", event => {
    ...
    global.DEEPER_DOWN_ROCK_TYPES.forEach(rockType => {
        ...
        event.blockModel(`${mod_id}:rock/cobble/${rockType}_slab`, model => {
        ...
        event.blockModel(`${mod_id}:rock/cobble/${rockType}_slab_double`, model => {
            model.parent("minecraft:block/cube_all")
            model.texture("all", global.STONE_TO_COBBLESTONE_TEXTURE[rockType])
        })

        event.blockModel(`${mod_id}:rock/cobble/${rockType}_slab_top`, model => {
        ...
        event.blockModel(`${mod_id}:rock/cobble/${rockType}_stairs`, model => {
        ...
        event.blockModel(`${mod_id}:rock/cobble/${rockType}_stairs_inner`, model => {
        ...
        event.blockModel(`${mod_id}:rock/cobble/${rockType}_stairs_outer`, model => {
        ...
        event.itemModel(`${mod_id}:rock/cobble/${rockType}_wall`, model => {
            model.parent("minecraft:block/wall_inventory")
            model.texture("wall", global.STONE_TO_COBBLESTONE_TEXTURE[rockType])
        })

        event.blockModel(`${mod_id}:rock/cobble/${rockType}_wall_post`, model => {
            model.parent("minecraft:block/template_wall_post")
            model.texture("wall", global.STONE_TO_COBBLESTONE_TEXTURE[rockType])
        })

        event.blockModel(`${mod_id}:rock/cobble/${rockType}_wall_side`, model => {
            model.parent("minecraft:block/template_wall_side")
            model.texture("wall", global.STONE_TO_COBBLESTONE_TEXTURE[rockType])
        })

        event.blockModel(`${mod_id}:rock/cobble/${rockType}_wall_side_tall`, model => {
