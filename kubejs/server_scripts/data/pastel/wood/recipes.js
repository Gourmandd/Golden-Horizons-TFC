...
ServerEvents.recipes(event => {
    ...
    global.PASTEL_WOOD_TYPES.forEach(wood => {
        ...
        if (global.NOXWOODS.indexOf(wood) > -1) {
            ...
            event.remove(`pastel:crafting_table/noxwood/${root}_planks`)
            event.remove(`pastel:crafting_table/noxwood/${root}_door`)
            event.remove(`pastel:crafting_table/noxwood/${root}_trapdoor`)
            event.remove(`pastel:crafting_table/noxwood/${root}_fence`)
            event.remove(`pastel:crafting_table/noxwood/${root}_fence_gate`)
            event.remove(`pastel:crafting_table/noxwood/${root}_pressure_plate`)
            ...
            if (wood == "weeping_gala") {
                ...
                event.remove(`pastel:crafting_table/colored_wood/${wood}_plank_planks`)
                event.remove(`pastel:crafting_table/colored_wood/${wood}_plank_fence`)
                event.remove(`pastel:crafting_table/colored_wood/${wood}_plank_fence_gate`)
                event.remove(`pastel:crafting_table/colored_wood/${wood}_plank_pressure_plate`)
            }
