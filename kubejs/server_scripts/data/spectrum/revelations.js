...
ServerEvents.generateData("after_mods", event => {
    ...
    CMY_COLOURS.forEach(colour => {
        ...
        Object.keys(states).forEach(block => {
            ...
            hideItem(`spectrum:milestones/reveal_colored_trees_cmy`, states[block], block, block.split(":").pop().split("/").pop().replace("_", " "))
            hideItem(`spectrum:milestones/reveal_colored_trees_cmy`, `${mod_id}:wood/lumber/${colour}`, "tfc:wood/lumber/oak", colour + " lumber")
        })
    })
    ...
    WHITE_COLOURS.forEach(colour => {
        ...
        Object.keys(states).forEach(block => {
            ...
            hideItem(`spectrum:milestones/reveal_colored_trees_w`, states[block], block, block.split(":").pop().split("/").pop().replace("_", " "))
            hideItem(`spectrum:milestones/reveal_colored_trees_w`, `${mod_id}:wood/lumber/${colour}`, "tfc:wood/lumber/oak", colour + " lumber")
        })
    })
    ...
    BLACK_COLOURS.forEach(colour => {
        ...
        Object.keys(states).forEach(block => {
            ...
            hideItem(`spectrum:milestones/reveal_colored_trees_k`, states[block], block, block.split(":").pop().split("/").pop().replace("_", " "))
            hideItem(`spectrum:milestones/reveal_colored_trees_k`, `${mod_id}:wood/lumber/${colour}`, "tfc:wood/lumber/oak", colour + " lumber")
        })
    })
