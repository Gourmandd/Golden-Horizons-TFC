...
ServerEvents.tags("item", event =>{
    ...
    SIGN_METALS.forEach(metal =>{
        global.AFC_WOOD_TYPES.forEach(wood =>{
            event.add("modpack:hanging_signs/metal/" + metal, "afc:wood/hanging_sign/" + metal + "/" + wood) 
            event.add("modpack:axles", "tfc:wood/bladed_axle/" + wood)  
        })
        global.TFC_WOOD_TYPES.forEach(wood =>{
            event.add("modpack:hanging_signs/metal/" + metal, "tfc:wood/hanging_sign/" + metal + "/" + wood)
            event.add("modpack:axles", "tfc:wood/bladed_axle/" + wood)  
        })
        event.add("modpack:hanging_signs", "#modpack:hanging_signs/metal/" + metal)
    })
