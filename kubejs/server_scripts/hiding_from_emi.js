ServerEvents.tags("item", event => {
    ...
    const ASSORTED = [
        ...
        "modpack:wood/sapling/chestnut_noxwood",
        "modpack:wood/sapling/slate_noxwood",
        "modpack:wood/sapling/ebony_noxwood",
        "modpack:wood/sapling/ivory_noxwood",
        "spectrum:black_sapling",
        "spectrum:blue_sapling",
        "spectrum:brown_sapling",
        "spectrum:cyan_sapling",
        "spectrum:gray_sapling",
        "spectrum:green_sapling",
        "spectrum:light_blue_sapling",
        "spectrum:light_gray_sapling",
        "spectrum:lime_sapling",
        "spectrum:magenta_sapling",
        "spectrum:orange_sapling",
        "spectrum:pink_sapling",
        "spectrum:purple_sapling",
