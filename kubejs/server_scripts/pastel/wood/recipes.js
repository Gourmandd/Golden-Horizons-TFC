...
ServerEvents.recipes(event =>{
    ...
    global.DYE_COLOURS.forEach(colour => {
        ...
        event.shaped(Item.of(`pastel:${colour}_planks`), ["LL", "LL"], {"L": `kubejs:wood/lumber/${colour}`})
            .id(`modpack:crafting/shaped/${colour}/planks`)

        event.shaped(Item.of(`pastel:${colour}_fence`, 8), ["PLP", "PLP"], {"L": `kubejs:wood/lumber/${colour}`, "P": `pastel:${colour}_planks`})
            .id(`modpack:crafting/shaped/${colour}/fence`)

        event.shaped(Item.of(`pastel:${colour}_fence_gate`, 2), ["LPL", "LPL"], {"L": `kubejs:wood/lumber/${colour}`, "P": `pastel:${colour}_planks`})
            .id(`modpack:crafting/shaped/${colour}/fence_gate`)

        event.shaped(Item.of(`pastel:${colour}_pressure_plate`, 1), ["LL"], {"L": `kubejs:wood/lumber/${colour}`})
    ...
    global.SPECTRUM_WOODS.forEach(wood => {
        ...
        if (global.NOXWOODS.indexOf(wood) > -1){
            ...
            event.shaped(Item.of(`pastel:${wood}_noxwood_planks`), ["LL", "LL"], {"L": `kubejs:wood/lumber/${wood}`})
                .id(`modpack:crafting/shaped/${wood}/planks`)

            event.shaped(Item.of(`pastel:${wood}_noxwood_door`, 2), ["LL", "LL", "LL"], {"L": `kubejs:wood/lumber/${wood}`})
                .id(`modpack:crafting/shaped/${wood}/door`)

            event.shaped(Item.of(`pastel:${wood}_noxwood_trapdoor`, 3), ["LLL", "LLL"], {"L": `kubejs:wood/lumber/${wood}`})
                .id(`modpack:crafting/shaped/${wood}/trapdoor`)

            event.shaped(Item.of(`pastel:${wood}_noxwood_fence`, 8), ["PLP", "PLP"], {"L": `kubejs:wood/lumber/${wood}`, "P": `pastel:${wood}_noxwood_planks`})
                .id(`modpack:crafting/shaped/${wood}/fence`)

            event.shaped(Item.of(`pastel:${wood}_noxwood_fence_gate`, 2), ["LPL", "LPL"], {"L": `kubejs:wood/lumber/${wood}`, "P": `pastel:${wood}_noxwood_planks`})
                .id(`modpack:crafting/shaped/${wood}/fence_gate`)
                
            event.shaped(Item.of(`pastel:${wood}_noxwood_pressure_plate`, 1), ["LL"], {"L": `kubejs:wood/lumber/${wood}`})
            ...
            event.shaped(Item.of(`pastel:${wood}_planks`), ["LL", "LL"], {"L": `kubejs:wood/lumber/${wood}`})
                .id(`modpack:crafting/shaped/${wood}/planks`)

            event.shaped(Item.of(`pastel:${wood}_door`, 2), ["LL", "LL", "LL"], {"L": `kubejs:wood/lumber/${wood}`})
                .id(`modpack:crafting/shaped/${wood}/door`)

            event.shaped(Item.of(`pastel:${wood}_trapdoor`, 3), ["LLL", "LLL"], {"L": `kubejs:wood/lumber/${wood}`})
                .id(`modpack:crafting/shaped/${wood}/trapdoor`)

            event.shaped(Item.of(`pastel:${wood}_fence`, 8), ["PLP", "PLP"], {"L": `kubejs:wood/lumber/${wood}`, "P": `pastel:${wood}_planks`})
                .id(`modpack:crafting/shaped/${wood}/fence`)

            event.shaped(Item.of(`pastel:${wood}_fence_gate`, 2), ["LPL", "LPL"], {"L": `kubejs:wood/lumber/${wood}`, "P": `pastel:${wood}_planks`})
                .id(`modpack:crafting/shaped/${wood}/fence_gate`)

            event.shaped(Item.of(`pastel:${wood}_pressure_plate`, 1), ["LL"], {"L": `kubejs:wood/lumber/${wood}`})
