...
StartupEvents.registry("block", event => {
    ...
    global.DYE_COLOURS.forEach(colour => {
        ...
        event.create(`wood/support/${colour}`/* getting 1.21 running, "tfc:support"*/)
    ...
    global.SPECTRUM_WOODS.forEach(wood => {
        ...
        if (global.NOXWOODS.indexOf(wood) > -1){
            ...
            event.create(`wood/twig/${wood}_noxwood`/* getting 1.21 running, "tfc:ground_cover"*/)
                .displayName(`${nameProcessing(wood)} Noxwood Twig`)
                /* getting 1.21 running.twig()*/
            ...
            event.create(`wood/support/${wood}`/* getting 1.21 running, "tfc:support"*/)
            ...
            event.create(`wood/twig/${wood}`/* getting 1.21 running, "tfc:ground_cover"*/)
